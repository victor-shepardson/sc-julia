...
function(sc_add_server_plugin dest_dir name cpp sc schelp shared_libs custom_deps)
    if(SCSYNTH)
        set(sy_name "${name}_scsynth")
        add_library(${sy_name} MODULE "${cpp}")
        add_dependencies(${sy_name} ${custom_deps})
    ...
    if(SUPERNOVA)
        ...
        add_dependencies(${sn_name} ${custom_deps})
